...
export default function About({ showToast }) {
  ...
  return (
    <main className="mx-auto px-margin-mobile md:px-margin-desktop py-lg space-y-lg md:space-y-xl max-w-6xl z-10 relative w-full overflow-x-hidden">
      ...
      <section className="flex flex-col md:flex-row items-center gap-lg py-md">
        ...
        <div className="w-full md:w-1/2 relative max-w-md mx-auto md:max-w-none order-1 md:order-2">
          <div className="aspect-square bg-secondary-fixed dark:bg-on-secondary-fixed-variant rounded-xl overflow-hidden bubbly-shadow relative p-sm">
            ...
            <div className="absolute bottom-2 left-2 sm:-bottom-md sm:-left-md bg-surface dark:bg-inverse-surface p-sm rounded-full bubbly-shadow animate-bounce" style={{ animationDuration: '3s' }}>
      ...
      {/* Services Section */}
      <section id="services" className="space-y-lg py-md w-full max-w-full overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter w-full max-w-full">
          {/* Service 1 */}
          <div className="pastel-glass-pink glow-card p-md md:p-lg rounded-[2rem] flex flex-col items-center text-center gap-sm transition-all duration-300 w-full">
          ...
          {/* Service 2 */}
          <div className="pastel-glass-blue glow-card p-md md:p-lg rounded-[2rem] flex flex-col items-center text-center gap-sm transition-all duration-300 w-full">
          ...
          {/* Service 3 */}
          <div className="pastel-glass-purple glow-card p-md md:p-lg rounded-[2rem] flex flex-col items-center text-center gap-sm transition-all duration-300 w-full">
      ...
      <section className="bg-surface-container-low dark:bg-zinc-900/50 p-md md:p-xl rounded-xl space-y-lg relative overflow-hidden border border-outline-variant/10 w-full max-w-full">
        ...
        <div className="relative z-10 space-y-md w-full max-w-full overflow-hidden mask-gradient py-4">
      ...
      <section className="space-y-lg py-md w-full max-w-full overflow-hidden">
        <div className="text-center space-y-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-md w-full max-w-full">
          {certificates.map((cert, i) => (
            <div
              key={i}
              onClick={() => setCertLightbox(cert)}
              className="glass-card glow-card p-md rounded-2xl flex flex-col group cursor-pointer w-full"
            >
      ...
      <section className="space-y-lg py-md w-full max-w-full overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-md w-full">
          ...
          <div className="space-y-lg relative w-full">
            {/* Step 1 */}
            <div className="flex flex-col sm:flex-row items-stretch sm:items-start sm:justify-between group w-full relative">
              <div className="w-full sm:w-[45%] order-2 sm:order-1 pl-[60px] sm:pl-0 sm:text-right">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-start sm:justify-between group w-full relative">
              ...
              <div className="w-full sm:w-[45%] pl-[60px] sm:pl-0 text-left">
      ...
      <section className="space-y-lg py-md">
        ...
        <div className="bg-surface-container-lowest dark:bg-zinc-900 p-md md:p-lg rounded-xl border border-surface-variant dark:border-outline/25 bubbly-shadow max-w-2xl mx-auto flex flex-col md:flex-row items-center gap-md">
